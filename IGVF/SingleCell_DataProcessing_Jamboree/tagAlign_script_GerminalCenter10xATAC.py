...
tagAlign_script_GerminalCenter10xATAC.py

Create tagAlign files for the given fragment and cell type annotation files

""")

#### required arguments ####

parser.add_argument("-f", "--fragment_file", help="""fragment file .tsv.gz""", required=True)
parser.add_argument("-c", "--cell_types_annot", help="""cell types annotation file .tsv.gz""", required=True)
args = parser.parse_args()

full_fragments_and_cell_type_labels = [(args.fragment_file, args.cell_types_annot)]
